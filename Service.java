...
import com.example.tempaturedisp.MainActivity;
import com.example.tempaturedisp.MainView;

interface CommandList {
	String CLIENT_CLOSED = "CLIENT_CLOSED";
	String SERVER_CLOSED = "SERVER_CLOSED";
	String SEND_MESSAGE = "SEND_MESSAGE";
	String CHANGE_TEMPATURE = "CHANGE_TEMPATURE";
}
...
public class ServiceCenter {
	...
	{
		MainActivity.getMainActivity().receiveSensorMessage(message);
	}
	...
	public void processCommand(String commandData)
	{
		...
		case CommandList.SEND_MESSAGE:	
			...
			break;
		case CommandList.CHANGE_TEMPATURE:		//温度变化	
			
			receiveSensorMessage(extraData);
			break;
		}
	}
}
